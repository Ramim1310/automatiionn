  ...
  return (
    <div className="glass-card p-6 flex flex-col items-center justify-center h-full min-h-[480px] gap-6 animate-fade-in">
      ...
      <div className="relative">
        <div className="w-24 h-24 rounded-full bg-blue-50 border border-blue-100 flex items-center justify-center pulse-slow">
        ...
        {/* Orbiting dot */}
        <div className="absolute -top-1 -right-1 w-6 h-6 rounded-full bg-white border border-blue-200 flex items-center justify-center">
      ...
      <div className="text-center space-y-2 max-w-xs">
        ...
        <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <span className="text-blue-600 font-medium">"Process Data"</span>{' '}
